...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Ernie's Point</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 5-27m</span>
						</div>
						<div class="info-badge">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Ernie's Point</strong> owes its name to Ernie's cave, a small cavern in
										21m where once
										lived Ernie the grouper. Ernie moved out many years ago but the dive site kept
										its name. The
										tiny cave is at the bottom of a large rocky outcrop, adorned with Sea Fans and
										often visited by
										smaller Groupers.
									</p>
									<p>
									...
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Small Groupers</li>
										<li><i class="icon-fish"></i> Large Mantis Shrimps</li>
										<li><i class="icon-fish"></i> Schools of Trevally</li>
										<li><i class="icon-fish"></i> Schools of Mackerel</li>
										<li><i class="icon-fish"></i> Various Reef Fish</li>
									</ul>
									<p>
										Look for tube shaped holes around the mouth of the cave, large Mantis Shrimps
										often build their nests here. Deeper, at 27m, lies another small cave with
										abundant marine life
										around it. None of the caves are large enough to penetrate.
									</p>
									<p>
										Schools of Trevally are common here,
										as are schools of Mackerel.
									</p>
									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Current Warning:</strong> Beware that during big tidal changes,
											strong cross currents (eddys)
											often happen here, and you might be stuck in a very small area between
											conflicting currents.
											Plan your dive according to the tides.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="10">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Ernie's Point? Join our next dive trip!</p>
									<a href="reservation.php?dive=ernies-point" class="btn btn-primary btn-block">
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.525147, 120.982809], 15); // Ernie's Point coordinates
		...
		// Add a marker
		L.marker([13.525147, 120.982809]).addTo(map)
			.bindPopup('<b>Ernie\'s Point</b><br>Diving Spot')
			.openPopup();
	</script>
