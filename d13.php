...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Fish Bowl</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 38-48m</span>
						</div>
						<div class="info-badge">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Fish Bowl</strong> is a deep dive that requires training for depths
										beyond 30m.
										This exceptional dive site should be on your wish list if you have the
										appropriate certification.
										The dive requires a blue water descent to the top of the Fish Bowl in 35-40m.
									</p>
									<p>
										The rocky reef top is stadium-shaped and is covered with long whip corals and
										soft tree corals.
										It drops off to a sandy bottom in deep water.
									</p>
									<p>
										The site is home to various marine life including:
									</p>
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Whitetip Reef Sharks</li>
										<li><i class="icon-fish"></i> Sweetlips</li>
										<li><i class="icon-fish"></i> Rainbow Runners</li>
										<li><i class="icon-fish"></i> Tuna</li>
										<li><i class="icon-fish"></i> Jacks</li>
										<li><i class="icon-fish"></i> Various Large Pelagics</li>
									</ul>
									<p>
										In the bowl, you may see Whitetip Reef Sharks, Sweetlips, and Rainbow Runners.
										Looking out
										into blue water, Tuna and jacks are common. After a few minutes in the bowl, you
										will be
										swimming up the contour of the reef to the Canyons.
									</p>
									<p>
										Technical divers can venture deeper into the Fish Bowl and work their way down.
										Here, rocky
										coral formations, Gorgonians, and black whip corals break up the sandy bottom,
										and it is
										possible to get close to some of the larger fish when there's a mild current.
									</p>
									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Current Warning:</strong> This dive can be done during stronger
											currents, but the
											Fish Bowl becomes difficult to navigate when currents are running, and you
											may find yourself
											swept off the reef. Plan accordingly and only dive this site with
											experienced guides who know
									...
									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Depth Warning:</strong> This is a deep dive requiring advanced or
											technical certification.
											The depth limits recreational dive times significantly. Proper deep diving
											protocols, equipment,
											and training are essential. Consider using trimix or other technical gas
											mixes for this dive.
										</div>
									</div>
								</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="13">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Fish Bowl? Join our next technical dive trip!</p>
									<a href="reservation.php?dive=fish-bowl" class="btn btn-primary btn-block">
										<i class="icon-ticket"></i> Book Now
									</a>
									<div class="certification-required">
										<i class="icon-warning"></i> Advanced/Technical certification required
									</div>
								</div>
							</div>
							...
							<div class="content-card">
								<div class="card-header">
									<h3><i class="icon-tools"></i> Special Requirements</h3>
								</div>
								<div class="card-body">
									<ul class="requirements-list">
										<li>Advanced Open Water certification (minimum)</li>
										<li>Deep diving specialty recommended</li>
										<li>Technical certification preferred</li>
										<li>Dive computer essential</li>
										<li>Enriched Air Nitrox highly recommended</li>
										<li>Technical divers: Stage bottles/multiple gases</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.525935, 120.993012], 15); // Fish Bowl coordinates
		...
		// Add a marker
		L.marker([13.525935, 120.993012]).addTo(map)
			.bindPopup('<b>Fish Bowl</b><br>Diving Spot')
			.openPopup();
	</script>
