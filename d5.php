...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Sabang Reef</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 38-50m</span>
						</div>
						<div class="info-badge">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Sabang Reef</strong> is a small area of a ridge line which runs for
										hundreds of metres
										both east and west. It is one of the most beautiful of the deep water coral
										gardens in the area
										with spectacular Gorgonian Fans, whips and formations of Giant Barrel Sponges.
									</p>
									<p>
										The reef is home to various marine life including:
									</p>
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Ribboned Sweetlips</li>
										<li><i class="icon-fish"></i> Barramundi Cod</li>
										<li><i class="icon-fish"></i> Emperor Angel Fish</li>
										<li><i class="icon-fish"></i> Clown Triggerfish</li>
										<li><i class="icon-fish"></i> Honeycomb Moray (up to 3m long)</li>
										<li><i class="icon-fish"></i> Bluespotted Stingrays</li>
									</ul>
									<p>
										In amongst the pinnacles at the base of this short wall you will find the
										obligatory school of inquisitive
										Ribboned Sweetlips, Barramundi Cod, Emperor Angel Fish, Clown Triggerfish and
										more. Somewhere in
										the nooks and crannies resides a Honeycomb Moray approaching 3m/10ft long, and
										the sandy reef
									...
									<div class="dive-note">
										...
										<div>
											<strong>Note:</strong> Due to the depth of this dive site (38-50m), it's
											recommended for advanced
											divers only. Proper deep diving techniques and nitrox are advised for this
											spectacular reef.
										</div>
									</div>
								</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="5">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Sabang Reef? Join our next dive trip!</p>
									<a href="reservation.php?dive=sabang-reef" class="btn btn-primary btn-block">
										<i class="icon-ticket"></i> Book Now
									</a>
									<div class="certification-required">
										<i class="icon-info"></i> Advanced certification and Nitrox required
									</div>
								</div>
							</div>
							...
							<div class="content-card">
								...
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Deep water coral garden</li>
										<li><i class="icon-check"></i> Spectacular Gorgonian Fans</li>
										<li><i class="icon-check"></i> Giant Barrel Sponges</li>
										<li><i class="icon-check"></i> Natural pinnacle formations</li>
										<li><i class="icon-check"></i> Home to 3m long Honeycomb Moray</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.525522, 120.977241], 15); // Sabang Reef coordinates
		...
		// Add a marker
		L.marker([13.525522, 120.977241]).addTo(map)
			.bindPopup('<b>Sabang Reef</b><br>Diving Spot')
			.openPopup();
	</script>
