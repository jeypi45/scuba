...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Boulders</h1>
					<div class="dive-site-quick-info">
						...
						<div class="info-badge">
							...
							<span>Boulder/Caves</span>
						</div>
						<div class="info-badge">
							<i class="icon-clock2"></i>
							<span>40-45min Dive</span>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Boulders</strong> is a unique dive site with dramatic rock formations.
										At the surface,
										you face a vertical stone wall and a few large boulders breaking the surface. As
										you descend
										underwater, down the slope, the site is covered with different shaped and sized
										boulders that
										look like they have rolled from the cliff and have come to rest on the slope,
										creating
										swim-throughs and caves and lots of hiding places for marine life.
									</p>

									<p>
										This unusual dive site doesn't sport much of the lush vegetation and colorful
										corals seen at
										other dive sites in Puerto Galera. Instead, you'll be treated to dramatic rock
										formations,
										black coral formations, schools of Snappers hovering over the reef, lots of
										Nudibranchs,
										and often Ribbon Eels and Cuttlefish.
									</p>
									...
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Thorny Seahorses</li>
										<li><i class="icon-fish"></i> Ribbon Eels</li>
										<li><i class="icon-fish"></i> Schools of Snappers</li>
										<li><i class="icon-fish"></i> Nudibranchs (various species)</li>
										<li><i class="icon-fish"></i> Cuttlefish</li>
										<li><i class="icon-fish"></i> Black Coral Formations</li>
										<li><i class="icon-fish"></i> Crustaceans in rock crevices</li>
									</ul>

									<p>
										This is where we find the Thorny Seahorse, the one that doesn't need a
										magnifying glass to be
										seen unlike its pygmy counterpart. They reside in 28-30m, unfortunately hiding
										in the rubble,
										but a good dive guide will find them for you.
									</p>

									<div class="dive-note">
										<i class="icon-lightbulb"></i>
										<div>
											<strong>Dive Tip:</strong> Bring your torch to light up the overhangs under
											the rocks
											to discover hidden marine life. This site is best dived on flood tide when
											there is no
											current as the area has a lot of silt sediment. It is a good site for
											wide-angle
											macro photography when the visibility is good.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="23">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore the Boulders? Join our next dive trip!</p>
									<a href="reservation.php?dive=boulders" class="btn btn-primary btn-block">
							...
							<div class="content-card">
								<div class="card-header">
									<h3><i class="icon-compass"></i> Special Features</h3>
								</div>
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Dramatic boulder formations</li>
										<li><i class="icon-check"></i> Swim-throughs and small caves</li>
										<li><i class="icon-check"></i> Black coral colonies</li>
										<li><i class="icon-check"></i> Thorny Seahorse habitat</li>
										<li><i class="icon-check"></i> Good for wide-angle macro photography</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.511456, 120.984364], 15); // Boulders coordinates
		...
		// Add a marker
		L.marker([13.511456, 120.984364]).addTo(map)
			.bindPopup('<b>Boulders</b><br>Diving Spot')
			.openPopup();
	</script>
