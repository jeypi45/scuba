...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Sabang Point</h1>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Sabang Point</strong> features pristine hard corals adorned with
										colorful Crinoids
										covering this beautiful reef from very shallow down to 25m. At 20m, you will
										encounter a small
										wall that drops off to a white sandy bottom. Big purple Sea Fans and whip corals
										are abundant
										on the deeper reef.
									</p>
									<p>
									...
									<ul class="marine-life-list">
										...
										<li><i class="icon-fish"></i> Sea Turtles (on good days)</li>
										<li><i class="icon-fish"></i> Pygmy Seahorses</li>
										<li><i class="icon-fish"></i> Blue Ribbon Eels</li>
										<li><i class="icon-fish"></i> Bluespotted Stingrays</li>
									</ul>
									<p>
										This healthy reef is abundant with reef fish such as Parrotfish, Snappers,
										Surgeonfish and
										Triggerfish but also sports Cuttlefish and Octopus as well as Turtles on a good
										day.
									</p>
									<p>
										Pygmy Seahorses are often spotted here on their fan corals, and Blue Ribbon Eels
										will await
										you on some of the sandy patches. Continue down to the end of the reef in 25m
										and find
									...
									<div class="dive-note">
										...
										<div>
											<strong>Pro Tip:</strong> For the best experience, bring an underwater torch
											to illuminate
											the vibrant colors of the corals and spot hidden macro life in the crevices.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="7">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Sabang Point? Join our next dive trip!</p>
									<a href="reservation.php?dive=sabang-point" class="btn btn-primary btn-block">
						...
						<div class="content-card">
							...
							<div class="card-body">
								<ul class="feature-list">
									<li><i class="icon-check"></i> Pristine hard corals with colorful Crinoids</li>
									<li><i class="icon-check"></i> Beautiful purple Sea Fans and whip corals</li>
									<li><i class="icon-check"></i> Small wall dropping to white sandy bottom</li>
									<li><i class="icon-check"></i> Perfect for macro photography</li>
									<li><i class="icon-check"></i> Excellent visibility year-round</li>
								</ul>
							</div>
						</div>
					</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.525397, 120.978153], 15); // Sabang Point coordinates
		...
		// Add a marker
		L.marker([13.525397, 120.978153]).addTo(map)
			.bindPopup('<b>Sabang Point</b><br>Diving Spot')
			.openPopup();
	</script>
