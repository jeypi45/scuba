...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Sabang Wreck</h1>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Sabang Wreck</strong> is perhaps the most famous dive site in Puerto
										Galera, and stands as
										the photographer's and macro lover's mecca. At first glance, the three wrecks
										don't look
										too impressive - one small steel yacht, and two wooden boats in different stages
										of
										decay. But look closer...
									</p>
									<p>
										The site is home to various marine life including:
									</p>
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Friendly Batfish schools</li>
										<li><i class="icon-fish"></i> Damselfish & Butterflyfish</li>
										<li><i class="icon-fish"></i> Camouflaged Scorpionfish & Stonefish</li>
										<li><i class="icon-fish"></i> Giant Moray Eels & Lionfish</li>
										<li><i class="icon-fish"></i> Frogfish on wrecks and sand</li>
										<li><i class="icon-fish"></i> Ghost Pipefish & Leaf Fish</li>
										<li><i class="icon-fish"></i> Various Crabs & Shrimps</li>
									</ul>
									<p>
										A school of very friendly Batfish will meet you as you get near the
										wrecks. Hopeful for food, they will come very close and make for very good video
										as they
										also attract lots of smaller Damselfish, Butterflyfish and Surgeonfish.
									</p>
									<p>
										Be careful not to get too close as numerous very well camouflaged Scorpionfish
										and
										Stonefish live on the wrecks. Bring a torch and look underneath, and you'll find
										giant
										Moray Eels, Lionfish, Crabs and Shrimps as well as schools of Catfish and
										Squirrelfish
										hiding during the day.
									</p>
									<p>
										The sandy areas around the wrecks are great places to study the many Goby
										and Shrimp relationships. With a great guide, you might also find robust Ghost
										Pipefish
										and Ornate Ghost Pipefish, moth fish, Flying Gurnards and Leaf Fish trying to
										blend into
										the sand.
									</p>
									<div class="dive-note">
										...
										<div>
											<strong>Night Dive Opportunity:</strong> This is a great night dive spot,
											with all the above marine life plus Shrimps,
											Hermit Crabs, Horseshoe Crabs, Sponge Crabs and Decorator Crabs out hunting
											for food.
											The dark also brings out Cuttlefish of all varieties, Squids,
											Pleurobranchus, Flatworms
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="6">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Sabang Wreck? Join our next dive trip!</p>
									<a href="reservation.php?dive=sabang-wreck" class="btn btn-primary btn-block">
										<i class="icon-ticket"></i> Book Now
									</a>
									<div class="certification-required">
										<i class="icon-info"></i> Suitable for all certification levels, great for night
										diving
									</div>
								</div>
							</div>
							...
							<div class="content-card">
								...
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Three accessible wrecks in one site</li>
										<li><i class="icon-check"></i> Perfect for macro photography</li>
										<li><i class="icon-check"></i> Excellent day and night diving</li>
										<li><i class="icon-check"></i> Shallow depth suitable for beginners</li>
										<li><i class="icon-check"></i> Rich biodiversity in a small area</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.524636, 120.977273], 15); // Sabang Wreck coordinates
		...
		// Add a marker
		L.marker([13.524636, 120.977273]).addTo(map)
			.bindPopup('<b>Sabang Wreck</b><br>Diving Spot')
			.openPopup();
	</script>
