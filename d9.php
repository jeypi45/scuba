...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Monkey Beach</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 5-24m</span>
						</div>
						<div class="info-badge">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Monkey Beach</strong> features a coral slope down to 20m which makes
										this an easy dive,
										except when currents are running – you can pick up quite a lot of speed here. If
										you drop in
										the middle of the bay, you will most likely encounter a wreck at 18m, tilted to
										the side.
									</p>
									<p>
									...
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Black Frogfish</li>
										<li><i class="icon-fish"></i> Shy Jawfish</li>
										<li><i class="icon-fish"></i> Mantis Shrimp</li>
										<li><i class="icon-fish"></i> Small Reef Fish</li>
										<li><i class="icon-fish"></i> Crinoids</li>
										<li><i class="icon-fish"></i> Nudibranchs</li>
									</ul>
									<p>
										Many Frogfish, especially the black variety, have made this area their home.
										Look around in
										the sand and you'll find lots of small holes, most of them inhabited by the shy
										Jawfish.
									</p>
									<p>
										See anything green running swiftly over the sand from one coral to the next?
										It's probably
										a Mantis Shrimp, they are very common here. The site also features plenty of
										small reef fish,
										Crinoids and Nudibranchs.
									</p>
									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Currents Note:</strong> Be aware that this site can experience
											strong currents at times.
											When currents are running, even beginners can pick up considerable speed,
											making this an
											exciting drift dive for the properly prepared diver.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="9">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Monkey Beach? Join our next dive trip!</p>
									<a href="reservation.php?dive=monkey-beach" class="btn btn-primary btn-block">
										<i class="icon-ticket"></i> Book Now
									</a>
									<div class="certification-required">
										<i class="icon-info"></i> Suitable for all certification levels, perfect for
										drift diving
									</div>
								</div>
							</div>
							...
							<div class="content-card">
								...
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Gentle coral slope perfect for beginners</li>
										<li><i class="icon-check"></i> Small wreck at 18m depth</li>
										<li><i class="icon-check"></i> Black Frogfish habitat</li>
										<li><i class="icon-check"></i> Jawfish colonies in sandy areas</li>
										<li><i class="icon-check"></i> Excellent for macro photography</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		...
		// Initialize the map
		var map = L.map('map').setView([13.524813, 120.981146], 15); // Monkey Beach coordinates
		...
		// Add a marker
		L.marker([13.524813, 120.981146]).addTo(map)
			.bindPopup('<b>Monkey Beach</b><br>Diving Spot')
			.openPopup();
	</script>
