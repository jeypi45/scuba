...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Monkey Wreck</h1>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Monkey Wreck</strong> is a challenging deep dive site. In 1993, a local
										20m pig boat
										sank and is now resting at between 40 and 45m. This is a deep dive and the
										combination
										of this with strong currents makes it one for the experienced diver only.
									</p>
									<p>
										Despite the fact that the wreck is mostly collapsed, many types of fish make it
										their home:
									</p>
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Large Emperor Angel Fish</li>
										<li><i class="icon-fish"></i> Schools of Blue Triggerfish</li>
										<li><i class="icon-fish"></i> Barramundi Cod</li>
										<li><i class="icon-fish"></i> Batfish</li>
										<li><i class="icon-fish"></i> Snappers</li>
										<li><i class="icon-fish"></i> Sweetlips</li>
										<li><i class="icon-fish"></i> Various Rays</li>
									</ul>
									<p>
										There is plenty of soft coral which is home to the diverse marine life. Beyond
										the wreck,
										you'll find a series of steep walls starting at the back of Monkey Wreck that
										are also
										worth exploring if your dive profile allows.
									</p>
									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Safety Note:</strong> Due to the depth (40-45m) and often strong
											currents,
											this dive is recommended for experienced divers only. Proper deep diving
											techniques
											and equipment are essential. Consider using enriched air nitrox to extend
											bottom time.
										</div>
									</div>
								</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="8">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Monkey Wreck? Join our next dive trip!</p>
									<a href="reservation.php?dive=monkey-wreck" class="btn btn-primary btn-block">
							...
							<div class="content-card">
								<div class="card-header">
									<h3><i class="icon-compass"></i> Wreck Highlights</h3>
								</div>
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Deep wreck at 40-45m</li>
										<li><i class="icon-check"></i> Former 20m local pig boat (sunk 1993)</li>
										<li><i class="icon-check"></i> Home to diverse large fish species</li>
										<li><i class="icon-check"></i> Adjacent to dramatic wall formations</li>
										<li><i class="icon-check"></i> Technical diving challenge</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.525679, 120.980653], 15); // Monkey Wreck coordinates
		...
		// Add a marker
		L.marker([13.525679, 120.980653]).addTo(map)
			.bindPopup('<b>Monkey Wreck</b><br>Diving Spot')
			.openPopup();
	</script>
