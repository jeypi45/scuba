...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Pink Wall</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 5-15m</span>
						</div>
						<div class="info-badge">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Pink Wall</strong> features a spectacular 12-meter (40 ft) long overhang
										completely
										covered with vibrant pink soft corals, giving the site its distinctive name. The
										maximum
										depth is 15m (50ft), while the top of the overhang sits at a perfect 5m (15ft),
										ideal for
										your safety stop.
									</p>
									<p>
										The site is particularly famous for night dives, where the colorful wall comes
										alive
										with fascinating marine activity. Best dived during a flood tide, you'll
										experience
										little to no current, making this suitable for divers of all experience levels.
									</p>
									...
									<ul class="marine-life-list">
										...
										<li><i class="icon-fish"></i> Various Crustaceans</li>
									</ul>

									<p>
										The stunning soft coral formations create a kaleidoscope of colors, particularly
										impressive when illuminated by dive lights during night dives. The many crevices
										and overhangs provide perfect hiding spots for nocturnal creatures.
									</p>

									<p>
										Pink Wall is often combined as the shallow finish to a dive at the nearby
										Shark Caves, allowing divers to experience two exceptional sites in a single
										dive.
									</p>
									...
									<div class="dive-note">
										...
										<div>
											<strong>Night Dive Tip:</strong> Pink Wall is especially magical during
											night dives.
											Bring a good underwater light to truly appreciate the vibrant pink colors of
											the
											soft corals and to spot hidden nocturnal creatures that emerge after dark.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="16">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Pink Wall? Join our next dive trip!</p>
									<a href="reservation.php?dive=pink-wall" class="btn btn-primary btn-block">
							...
							<div class="content-card">
								<div class="card-header">
									<h3><i class="icon-thumb-tack"></i> Special Features</h3>
								</div>
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Vibrant pink soft coral coverage</li>
										<li><i class="icon-check"></i> 12m long spectacular overhang</li>
										<li><i class="icon-check"></i> Excellent for underwater photography</li>
										<li><i class="icon-check"></i> Minimal current during flood tide</li>
										<li><i class="icon-check"></i> Perfect 5m safety stop location</li>
										<li><i class="icon-check"></i> Can combine with Shark Caves dive</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.521638, 120.993956], 15); // Pink Wall coordinates
		...
		// Add a marker
		L.marker([13.521638, 120.993956]).addTo(map)
			.bindPopup('<b>Pink Wall</b><br>Diving Spot')
			.openPopup();
	</script>
