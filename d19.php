...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Kilima Beach/Steps</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 5-40m</span>
						</div>
						<div class="info-badge">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Kilima Beach/Steps</strong> is a fantastic dive site celebrated for the
										diverse fish
										and coral found here. Starting in shallow water, the dive site consists of flat
										areas broken up
										by small walls – ridges – at all depths, with the deepest one at 30m.
									</p>

									<p>
										The reef is literally teeming with life, making this one of the most biodiverse
										sites in
										Puerto Galera. You'll encounter a wide variety of marine species as you explore
										the different
										depth zones and ridge formations.
									</p>
									...
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Schools of Anthias</li>
										<li><i class="icon-fish"></i> Surgeonfish (including "Dory")</li>
										<li><i class="icon-fish"></i> Angel Fish</li>
										<li><i class="icon-fish"></i> Butterflyfish</li>
										<li><i class="icon-fish"></i> Parrotfish</li>
										<li><i class="icon-fish"></i> Moray Eels (multiple species)</li>
										...
										<li><i class="icon-fish"></i> Batfish (around 18m)</li>
										<li><i class="icon-fish"></i> Longnose Emperor Fish</li>
										<li><i class="icon-fish"></i> Pygmy Seahorses</li>
										<li><i class="icon-fish"></i> Palette Surgeonfish ("Dory")</li>
										<li><i class="icon-fish"></i> Redtoothed Triggerfish</li>
									</ul>

									<p>
										Moray Eels are very common here, and you will find one or two under most coral
										heads or rocks,
										often different species sharing a hole. A school of Batfish tends to hang around
										at 18m, and
										a big school of hunting Longnose Emperor Fish very often speed past on their way
										to find prey.
									</p>

									<p>
										This is the only place in Puerto Galera where you can admire the beautiful
										Palette Surgeonfish
										(or "Dory" from the movie "Finding Nemo"). By the deeper walls, schools of
										Redtoothed
										Triggerfish will appear above you as you cruise along.
									</p>

									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Current Warning:</strong> This dive must be done on a flood tide, or
											it will turn
											into the infamous "Kilima Drift" - a much more challenging dive with strong
											currents. Always
											check with your dive guide about the current conditions before entering the
											water.
										</div>
									</div>
								</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="19">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Kilima Beach/Steps? Join our next dive trip!</p>
									<a href="reservation.php?dive=kilima-beach" class="btn btn-primary btn-block">
							...
							<div class="content-card">
								<div class="card-header">
									<h3><i class="icon-heart3"></i> Special Features</h3>
								</div>
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Exceptional marine biodiversity</li>
										<li><i class="icon-check"></i> Only place to see "Dory" fish in Puerto Galera
										</li>
										<li><i class="icon-check"></i> Multiple reef ridges at different depths</li>
										<li><i class="icon-check"></i> Common sightings of Pygmy Seahorses</li>
										<li><i class="icon-check"></i> Excellent for underwater photography</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.519405, 120.992454], 15); // Kilima Beach coordinates
		...
		// Add a marker
		L.marker([13.519405, 120.992454]).addTo(map)
			.bindPopup('<b>Kilima Beach/Steps</b><br>Diving Spot')
			.openPopup();
	</script>
