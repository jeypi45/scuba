...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Japanese Wreck</h1>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										The <strong>Japanese Wreck</strong> is situated on a flat sandy bottom. All that
										remains of this WWII Japanese patrol
										boat is the engine block and propeller shaft with the propeller.
									</p>
									<p>
										Today this wreck is home to a variety of marine life including:
									</p>
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Large Moray Eels</li>
										<li><i class="icon-fish"></i> Sweetlips</li>
										<li><i class="icon-fish"></i> Various Small Invertebrates</li>
									</ul>
									<p>
										A flashlight and a good dive guide make for a good dive, since the dive site can
										be hard to find.
									</p>
									...
									<div class="dive-note">
										...
										<div>
											<strong>Note:</strong> This is a dive preferably done on nitrox and can only
											be done on a flood tide.
											Follow the slope up towards Boulders after you've finished admiring the
											propeller,
											and make your way between the rocks into shallow water.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="24">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore the Japanese Wreck? Join our next dive trip!</p>
									<a href="reservation.php?dive=japanese-wreck" class="btn btn-primary btn-block">
							...
							<div class="content-card">
								...
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> WWII Japanese Wreck Site</li>
										<li><i class="icon-check"></i> Original Propeller</li>
										<li><i class="icon-check"></i> Nitrox Recommended</li>
										<li><i class="icon-check"></i> Historical Significance</li>
										<li><i class="icon-check"></i> Large Moray Eels Habitat</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.509553, 120.983951], 15); // Japanese Wreck coordinates
		...
		// Add a marker
		L.marker([13.509553, 120.983951]).addTo(map)
			.bindPopup('<b>Japanese Wreck</b><br>Diving Spot')
			.openPopup();
	</script>
