...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Hole in the Wall</h1>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Hole in the Wall</strong> is situated on Escarceo Point, where the
										actual "hole in the wall"
										is a short tunnel at 12m through a mini mountain that constitutes the dividing
										range between ebb
										and tide. This makes for a very beautiful – and sometimes exciting – dive.
									</p>
									<p>
										As is common in an area where currents meet, you can expect lots of schooling
										fish. The top of the
										wall is covered in colorful soft coral attracting many colorful fish.
									</p>
									<p>
										The site is home to various marine life including:
									</p>
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Drummers</li>
										<li><i class="icon-fish"></i> Sweetlips</li>
										<li><i class="icon-fish"></i> Trevallies</li>
										<li><i class="icon-fish"></i> Snappers</li>
										...
										<li><i class="icon-fish"></i> Turtles</li>
										<li><i class="icon-fish"></i> Sea Snakes</li>
									</ul>
									<p>
										The occasional pair of giant trevally can be seen hovering high above the rocky
										outcropping.
										While swimming through the hole, be aware of the Lionfish and Scorpionfish that
										are common here,
										as well as the feather-like Hydroids growing on the walls – they sting! Good
										buoyancy is a must.
									</p>
									<p>
										On the other side of the wall lies another wall, definitely worth exploring if
										the current allows it.
										It's covered in soft coral, sponges, green tree coral and fans, making it the
										hiding place for many
										Moray Eels and Puffer Fishes. The wall drops off into a flat lunar-like
										landscape with whole gardens
										of whip corals vibrating in the current.
									</p>

									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Current Warning:</strong> This can be a very easy dive, even for
											novices – with good buoyancy
											control. Be aware however that on strong floods, the current can get very
											tough and down currents
											are common, making you bounce up and down like a yo-yo on your way to the
											surface. Stay close to
											your guide and to the bottom!
										</div>
									</div>
									...
									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Hazard Warning:</strong> While swimming through the hole, watch out
											for Lionfish,
											Scorpionfish and the feather-like Hydroids growing on the walls – they all
											sting! Maintain
											good buoyancy control to avoid contact with these organisms.
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="15">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to explore Hole in the Wall? Join our next dive trip!</p>
									<a href="reservation.php?dive=hole-in-the-wall" class="btn btn-primary btn-block">
										<i class="icon-ticket"></i> Book Now
									</a>
									<div class="skill-note">
										<i class="icon-info"></i> *Good buoyancy control required
									</div>
								</div>
							</div>
							...
							<div class="content-card">
								<div class="card-header">
									<h3><i class="icon-map-marker"></i> Special Features</h3>
								</div>
								<div class="card-body">
									<ul class="feature-list">
										<li><i class="icon-check"></i> Short swim-through tunnel at 12m</li>
										<li><i class="icon-check"></i> Convergence of ebb and tide currents</li>
										<li><i class="icon-check"></i> Colorful soft coral landscapes</li>
										<li><i class="icon-check"></i> Gardens of whip coral</li>
										<li><i class="icon-check"></i> Great for photography in calm conditions</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.523954, 120.992582], 15); // Hole in the Wall coordinates
		...
		// Add a marker
		L.marker([13.523954, 120.992582]).addTo(map)
			.bindPopup('<b>Hole in the Wall</b><br>Diving Spot')
			.openPopup();
	</script>
