...
<body>
		...
		<section class="dive-site-container">
			<div class="container">
				...
				<div class="dive-site-header">
					<h1 class="dive-site-title">Canyons</h1>
					<div class="dive-site-quick-info">
						<div class="info-badge">
							<i class="icon-arrow-down"></i>
							<span>Depth: 22-32m</span>
						</div>
						<div class="info-badge">
						...
						<div class="info-badge">
							...
							<span>Drift Dive/Canyon</span>
						</div>
						<div class="info-badge">
							<i class="icon-clock2"></i>
							<span>30-45min Dive</span>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="content-card">
								...
								<div class="card-body">
									<p>
										<strong>Canyons</strong> is a world-class exhilarating drift dive - "the dive"
										to do in Puerto Galera
										if you are an experienced diver with a taste for the fast and furious. Drop in
										close to Hole in
										the Wall and let the current take you deeper along the slope until you reach an
										area where
										currents and mother nature have formed three spectacular canyons in the reef.
									</p>
									<p>
										The canyons all have sheltering walls and sandy bottoms, where you can kneel
										down and rest –
										and watch the big fish fighting in the current above your head. On all sides of
										the Canyons,
										the slope quickly drops down to 40m plus, so the only way once you get to the
										Canyons is… up!
									</p>
									...
									<ul class="marine-life-list">
										<li><i class="icon-fish"></i> Schooling Drums</li>
										...
										<li><i class="icon-fish"></i> Large Sea Fans</li>
									</ul>

									<p>
										At the end of the third and deepest canyon (30m), there is an old 1.5-meter
										anchor embedded in
										the rock, where divers often meet and hold on before letting go and starting the
										blue water
										ascent.
									</p>

									<p>
										This is the one dive site where even bigger animals are sometimes spotted: Manta
										Rays,
										Thresher Sharks and Hammerhead Sharks have all been seen here.
									</p>

									<div class="dive-note">
										<i class="icon-warning"></i>
										<div>
											<strong>Current Warning:</strong> This is a dive site that changes every
											time you experience it.
											On a slack tide it can be a gorgeous dive for photographers, whereas on a
											strong ebb it can
											scare the most jaded of divers. Best done with enriched air nitrox, the dive
											ends with a blue
											water ascent and a safety stop in blue water. By the time you exit you'll
											have drifted far off
											into the ocean. Make sure that you stay with and behind your guide at all
											times.
										</div>
									</div>
								</div>
						...
						<div class="col-md-4">
							...
							<div class="content-card rating-card">
								...
								<div class="card-body">
									<div id="rating-section" data-item-id="14">
							...
							<div class="content-card booking-card">
								...
								<div class="card-body">
									<p>Ready to experience the exhilarating Canyons drift dive? Join our next trip!</p>
									<a href="reservation.php?dive=canyons" class="btn btn-primary btn-block">
										<i class="icon-ticket"></i> Book Now
									</a>
									<div class="experience-level-alert">
							...
							<div class="content-card">
								...
								<div class="card-body">
									<ul class="equipment-list">
										<li><i class="icon-check"></i> Surface Marker Buoy essential</li>
										<li><i class="icon-check"></i> Enriched Air Nitrox recommended</li>
										<li><i class="icon-check"></i> Reef hook may be useful</li>
										<li><i class="icon-check"></i> Dive computer with depth alarm</li>
										<li><i class="icon-check"></i> Backup air source recommended</li>
									</ul>
								</div>
							</div>
						</div>
	...
	<script>
		// Initialize the map
		var map = L.map('map').setView([13.524871, 120.994363], 15); // Canyons coordinates
		...
		// Add a marker
		L.marker([13.524871, 120.994363]).addTo(map)
			.bindPopup('<b>Canyons</b><br>Diving Spot')
			.openPopup();
	</script>
